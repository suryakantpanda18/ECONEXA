...
function buildSidebar(user) {
  const navByRole = {
    citizen: [
      ...
      { route: '#citizen-map',       icon: 'map',        label: 'EcoMap' },
      ...
      { route: '#citizen-complaints',icon: 'alert_circle',label: 'Complaints', badge: () => EcoData.complaints.filter(c => c.citizenId === user.id && c.status !== 'resolved').length },
    ...
    admin: [
      ...
      { route: '#admin-analytics',   icon: 'bar_chart',  label: 'Analytics' },
      { route: '#admin-workers',     icon: 'users',      label: 'Workers' },
      { route: '#admin-facilities',  icon: 'factory',    label: 'Facilities' },
      { route: '#admin-complaints',  icon: 'alert_circle', label: 'Complaints', badge: () => EcoData.complaints.filter(c => c.status !== 'resolved').length },
      { route: '#admin-map',         icon: 'map',        label: 'EcoMap' },
    ...
    authority: [
      ...
      { route: '#authority-analytics', icon: 'bar_chart', label: 'Analytics' },
      { route: '#authority-reports',   icon: 'file_text', label: 'Reports' },
